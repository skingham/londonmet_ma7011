...
\input{assignment_quantum_computing_concepts}
...
\input{assignment_shor_grover_implementation}
...
\input{assignment_post_quantum_cryptography}
...
\input{appendix_qiskit_intro/assignment_qiskit_intro}

%\graphicspath{ {appendix_shor_circuit/} }
%\input{appendix_shor_circuit/assignment_shor_circuit}

\graphicspath{ {appendix_grover_circuit/} }
\input{appendix_grover_circuit/assignment_grover_circuit}
