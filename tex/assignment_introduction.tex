...
understand the SDK and the implementation of the Shor and Grover algorithms.  Section 3 develops the actual code that runs on IBMs
systems and shows the results, demonstrating the the power and some limitations using the current generation of
